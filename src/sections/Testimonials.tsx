  ...
  return (
    <section className="bg-white pt-[10rem]">
      <div className="container">
        ...
        {/* reviews */}
        <div className="flex justify-center gap-6 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] mt-10 overflow-hidden max-h-[738px]">
          <TestimonialsColumn
